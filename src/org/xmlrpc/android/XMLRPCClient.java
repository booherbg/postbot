...
import org.hopto.group18.postbot.PostBot;
...
public class XMLRPCClient {
	...
	public XMLRPCClient(URI uri) {
		...
		//httpParams.setParameter("http.socket.timeout", new Integer(PostBot.HTTP_SOCKET_TIMEOUT));
		
		client = new DefaultHttpClient();
		client.getParams().setParameter("http.connection.timeout", new Integer(PostBot.HTTP_SOCKET_TIMEOUT));
